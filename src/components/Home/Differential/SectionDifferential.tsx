            ...
            <Container>
                <div className="differential-section flex w-full justify-start">
                    <div className="flex-1 max-w-[620px] w-full mt-[100px]">
                        ...
                        <div className="benefits flex justify-center items-center w-full h-[340px] border-primary-color rounded-[20px] shadow-2xl">
                            <div className="benefits-grid p-5 grid grid-cols-2 gap-5 m-8">
