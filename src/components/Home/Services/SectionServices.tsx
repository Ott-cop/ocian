                ...
                <div className="block justify-center">
                    <div className="flex relative justify-center w-full mb-6 ">
                        <div className="w-[1000px]">
                            ...
                            <p className="text-[18px] text-center mb-14">Oferecemos sistemas de gerenciamento com soluções inteligentes, seguras e de fácil operabilidade.
                                E priorizamos sempre a eficácia no atendimento, seja no suporte técnico, implantação ou monitoramento.</p>
                        </div>
                    </div>
                    <div className="flex w-full justify-center">
                        <div className="grid grid-cols-7 w-[1000px] justify-center gap-8">
